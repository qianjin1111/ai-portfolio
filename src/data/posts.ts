...
`,
  ...
  {
    id: 11,
    title: 'GitHub 项目深度学习方法论：从代码理解到技术沉淀',
    excerpt: '系统性总结GitHub项目深度学习的四层流程、五维度分析框架和代码分析技巧，以4个AI Agent记忆管理项目的学习实践为例，沉淀一套可复用的开源项目学习方法论，适用于任何技术领域的GitHub项目深度学习。',
    content: `# GitHub 项目深度学习方法论：从代码理解到技术沉淀
...
`,
    ...
    readTime: '20 min',
    category: 'Tech Analysis',
    tags: ['Learning Methodology', 'GitHub', 'Open Source', 'Deep Learning'],
  },
];
